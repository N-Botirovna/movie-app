...
function SingleTv() {
  ...
  return (
    <div className="container flex pr- gap-10  p-4 mx-auto  bg-gray-900 ">
      <>
          <div className="img-div w-2/3">
            <img className="rounded w-full" src={`https://image.tmdb.org/t/p/w500/${state.data.backdrop_path}`} alt="img" />
          </div>
          <div className="right-div pr-6 text-white">
            <h1 className=" text-5xl mb-2 text-bold">{state.data.name}</h1>
            ...
            <div>
              <p className="text-2xl text-bold">Status:</p>
